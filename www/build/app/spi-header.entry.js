...
class SpiHeader {
    ...
    render() {
        return (h("nav", { class: "navbar is-shady", role: "navigation", "aria-label": "main navigation" },
            h("div", { class: "container" },
                h("div", { class: "navbar-brand" },
                    h("span", { class: "navbar-item" },
                        h("a", { href: "/" },
                            h("img", { src: "../assets/icon/edu.png", width: "50", height: "120" }),
                            h("span", null)),
                        h("span", null,
                            h("b", null, "SPI-ADMINISTRATION"))),
                    h("a", { role: "button", class: "navbar-burger burger", "aria-label": "menu", "aria-expanded": "false", "data-target": "navbar-content", onClick: () => this.toggleBurger(), ref: el => (this.burger = el) },
                        h("span", { "aria-hidden": "true" }))),
                h("div", { id: "navbar-content", class: "navbar-menu", ref: el => (this.menu = el) },
                    h("div", { class: "navbar-start" }),
                    h("span", { class: "navbar-item" },
                        h("stencil-route-link", { url: "/formation/", activeClass: "none" },
                            h("span", { class: "has-text-primary fa-lg" },
                                h("i", { class: "fas fa-tools" })),
                            " ",
                            "Formation")),
                    h("span", { class: "navbar-item" },
                        h("stencil-route-link", { url: "/ens/", activeClass: "none" },
                            h("span", { class: "has-text-primary" },
                                h("i", { class: "fas fa-user-alt fa-lg" })),
                            " ",
                            "Enseignant")),
                    h("span", { class: "navbar-item" },
                        h("stencil-route-link", { url: "/candidat/", activeClass: "none" },
                            h("span", { class: "has-text-primary fa-lg" },
                                h("i", { class: "fas fa-graduation-cap" })),
                            " ",
                            "Candidat")),
                    h("span", { class: "navbar-item" },
                        h("stencil-route-link", { url: "/promotion/", activeClass: "none" },
                            h("span", { class: "has-text-primary fa-lg" },
                                h("i", { class: "fas fa-book" })),
                            " ",
                            "Promotion")),
                    h("span", { class: "navbar-item" },
                        h("stencil-route-link", { url: "/login" },
                            h("a", { class: "button is-small is-primary is-outlined", href: "/login" },
                                h("p", { class: "control" },
                                    h("span", { class: "icon" },
        ...
        return (h("div", null,
            ...
            h("stencil-router", null,
                h("stencil-route-switch", { scrollTopOffset: 0 },
                    ...
                    h("stencil-route", { url: "/ens/NewEnseignant", component: "add-ens", exact: true }),
                    h("stencil-route", { url: "/ens/", component: "spi-enseignant", exact: true }),
                    h("stencil-route", { url: "/ens/:noEnseignant", component: "detail-enseignant" }),
                    h("stencil-route", { url: "/login", component: "spi-login" }),
                    h("stencil-route", { url: "/formation", component: "spi-formation" }),
                    h("stencil-route", { url: "/candidat", component: "spi-candidat" }),
                    h("stencil-route", { url: "/promotion", component: "spi-promotion" })))));
    }
