...
function createComponentOnReadyPrototype(win, namespace, HTMLElementPrototype) {
  ...
  })(window, document, "App","app",0,"app.core.js","es5-build-disabled.js","hydrated","add-ens,detail-enseignant,detail-search,spi-candidat,spi-enseignant,spi-formation,spi-header,spi-home,spi-login,spi-promotion,spi-root,stencil-route,stencil-route-link,stencil-route-switch,stencil-router",HTMLElement.prototype);